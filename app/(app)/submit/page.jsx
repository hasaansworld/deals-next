...
export default function Submit() {
	...
	return (
		<div className="flex flex-col items-center px-4 py-20 md:px-20">
			...
			<p className="mt-2 text-xs font-medium text-neutral-400">{count ? `${count ? Math.max(0, 100 - count) : 100} free spots left` : '...'}</p>

			<p className="mt-2 text-xs font-medium text-neutral-400">Count is {count}</p>
