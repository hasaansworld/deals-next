...
const Footer = () => {
	return (
		<footer className="mt-10 w-full bg-gray-50 px-6 py-10">
			<div className="flex flex-col items-center gap-4 md:mx-auto md:w-[700px] md:flex-row md:justify-between lg:w-[800px]">
				...
				<div className="flex items-center gap-6 md:gap-20 lg:gap-32">
