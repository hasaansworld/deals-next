...
const Header = () => {
	...
	return (
		<header className="fixed left-0 top-0 z-10 w-full bg-black py-2 backdrop-blur-2xl backdrop-filter">
			<div className="container mx-auto flex items-center justify-between px-40">
				...
				<div className="mx-32 flex w-96 items-center space-x-2 rounded-xl border border-neutral-800 bg-transparent px-4 py-1.5 transition-colors duration-300 focus-within:bg-neutral-900">
