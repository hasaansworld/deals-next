...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Trigger
		ref={ref}
		className={cn(
			`focus:ring-fuchisa-200 flex h-10 w-full items-center justify-between ${
				props.left ? 'rounded-l-md' : 'rounded-md'
			} border border-neutral-200 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-neutral-500 focus:border-fuchsia-300 focus:outline-none focus:ring-2 focus:ring-fuchsia-200 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-800 dark:bg-neutral-950 dark:ring-offset-neutral-950 dark:placeholder:text-neutral-400 dark:focus:ring-neutral-300 [&>span]:line-clamp-1`,
			className,
		)}
		{...props}
	>
