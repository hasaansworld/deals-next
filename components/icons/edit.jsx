const Edit02Icon = ({ stroke = '1.5', ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill={'none'} {...props}>
		...
		/>
		<path d="M13 4L20 11" stroke="currentColor" strokeWidth={stroke} strokeLinejoin="round" />
		<path d="M14 22L22 22" stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" />
	</svg>
);
